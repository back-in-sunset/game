...
const file_rpc_user_proto_rawDesc = "" +
	...
	"\x04Name\x18\x02 \x01(\tR\x04Name\x12\x16\n" +
	"\x06Gender\x18\x03 \x01(\x03R\x06Gender\x12\x16\n" +
	"\x06Mobile\x18\x04 \x01(\tR\x06Mobile2\xd2\x01\n" +
	"\x04User\x12<\n" +
	"\x05Login\x12\x18.userclient.LoginRequest\x1a\x19.userclient.LoginResponse\x12E\n" +
	"\bRegister\x12\x1b.userclient.RegisterRequest\x1a\x1c.userclient.RegisterResponse\x12E\n" +
	"\bUserInfo\x12\x1b.userclient.UserInfoRequest\x1a\x1c.userclient.UserInfoResponseB\aZ\x05/userb\x06proto3"
