...
type (
	...
	CommentContentModel interface {
		...
		// FindOne(ctx context.Context, objeID int64, commentID int64) (*CommentContent, error)
		// Update(ctx context.Context, data *CommentContent) error
		// Delete(ctx context.Context, objID int64, commentID int64) error
	}
...
func newCustomCommentContentModel(conn sqlx.SqlConn, c cache.CacheConf, shardingID int64, opts ...cache.Option) *customCommentContentModel {
	table := fmt.Sprintf("`comment_content_%d`", shardingID&0xFF)
	defaultCommentContentModel := newCommentContentModel(conn, c, opts...)
	defaultCommentContentModel.table = table
	return &customCommentContentModel{
		CachedConn:                 sqlc.NewConn(conn, c, opts...),
		defaultCommentContentModel: defaultCommentContentModel,
		table:                      table,
		// CachedConn: sqlc.NewConn(conn, c, opts...),
...
// func (m *customCommentContentModel) FindOne(ctx context.Context, objID int64, commentID int64) (*CommentContent, error) {
...
// func (m *customCommentContentModel) Delete(ctx context.Context, objID int64, commentID int64) error {
// 	commentContentCommentIDKey := fmt.Sprintf("%s%v%v", cacheCommentContentObjIDCommentIDPrefix, objID, commentID)
