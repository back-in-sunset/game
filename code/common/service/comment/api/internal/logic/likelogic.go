...
func (l *LikeLogic) Like(req *types.CommentActionRequest) (*types.CommentActionResponse, error) {
	if req.ObjID <= 0 {
	...
	res, err := l.svcCtx.CommentRpc.LikeComment(l.ctx, &commentclient.LikeCommentRequest{
		ObjID:     req.ObjID,
		ObjType:   req.ObjType,
